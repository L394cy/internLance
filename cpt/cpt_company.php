...
class CPT_Companies {
    ...
    function __construct() {
        add_action('init', array($this, 'cpt_companies'));
    }
	...
	$labels = array(
		...
		'all_items'             => __( 'Company', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Company', 'text_domain' ),
		'labels'                => $labels,
...
global $CPT_Companies;
$CPT_Companies = new CPT_Companies();